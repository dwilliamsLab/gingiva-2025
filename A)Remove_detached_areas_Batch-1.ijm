//Removing unregistered areas for experimental batch 1 (containing samples P2a, P2b, H2a, H2b, H3, P6, P8). These had one additional Hoechst channel (one additional IBEX cycle). The rest of the channels were identical)
...
//Delete Hoechsts from the first 6 cycles and CD68 channel (poor performance).
...
//This is a way to remove for example a major epithelial area (expressing CK5 from the first cycle) that was later detached. The nuclei had already been removed but the other channels were not.
...
roiManager("Show None");
roiManager("Show None");
//Change order of CD3 and Thy-1 manually (they were in different order in the first experiment-batch). Stacks<Tools<Stack Sorter. They are Channel 10 and 11.
